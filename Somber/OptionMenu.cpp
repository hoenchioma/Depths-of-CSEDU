...
//
//		
//	soundButton.Init(&SoundButtonAc,&SoundButton, soundX,soundY);
...
//	soundButton.objet.setPosition(soundX,soundY);
//	fullscreenButton.objet.setPosition(fullscreenX,fullscreenY);
...
//	}
//	
//	if (mouseCor.x >= fullscreenX && mouseCor.x <= fullscreenX+268 && mouseCor.y >= fullscreenY && mouseCor.y <= fullscreenY+50)
//	{
//		if (Mouse::isButtonPressed(Mouse::Left))
//		{
//			_fullScreen=_fullScreen^1;
//		}///////fullscreen button
//
//	}
...
//	if (!pause)
//	{
//		if(  ) soundButton.object.setTexture(SoundButtonOff); //////////////sound variable
